...
$routeProvider.when('/new-package', {templateUrl: 'partials/new-package.html', controller: 'NewPackageController'});
  ...
  $routeProvider.when('/created-packages/:pid/reserve/hotelSearch/searchResults', {templateUrl: 'partials/hotel-searchResults.html', controller: 'HotelSearchResultsController'});  
  $routeProvider.when('/created-packages/:pid/reserve/hotelSearch/hotelBook', {templateUrl: 'partials/hotel-book.html', controller: 'HotelSearchResultsController'});
  $routeProvider.when('/created-packages/:pid/reserve/hotelSearch/booked', {templateUrl: 'partials/hotel-book-confirm.html', controller: 'HotelSearchResultsController'});
